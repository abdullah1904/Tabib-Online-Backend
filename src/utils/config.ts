...
export const config = {
    ...
    HUGGINGFACEHUB_API_TOKEN: getValue("HUGGINGFACEHUB_API_TOKEN", null),
    HUGGINGFACEHUB_EMBEDDING_MODEL: getValue("HUGGINGFACEHUB_EMBEDDING_MODEL", "BAAI/bge-large-en-v1.5"),
